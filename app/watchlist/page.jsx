...
const WatchlistPage = () => {
  const { movies, watchLater } = useMovies()
  const watchlistMovies = movies.filter((m) => watchLater.includes(m.id))
    ...
    <main className="min-h-screen px-6 py-12" style={{ background: 'var(--black)' }}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-12">
             <h1 className="font-bebas text-2xl tracking-[0.2em] text-gold">My Watchlist</h1>
        ...
        {watchlistMovies.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-60 gap-4"
            ...
            <p className="font-bebas text-3xl tracking-widest">Nothing saved yet</p>
